...
export function auditEnglishSeoArticle(article,topic,opts={}){
 ...
 addCheck(checks,'content','word_floor',wordCount>=900&&wordCount<=1800,5,{critical:wordCount<750||wordCount>2000,note:String(wordCount)});addCheck(checks,'content','sections',h2>=6&&h2<=12,3,{critical:h2>16,note:String(h2)});addCheck(checks,'content','readability',pstats.count>=8&&pstats.max<=150,2);
