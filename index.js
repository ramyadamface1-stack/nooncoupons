...
function couponsPage(){
  ...
  return layout('كل كوبونات نون السعودية والإمارات | 16 بطاقة كوبون','اعرض الأكواد الثمانية للسعودية والعشرة للإمارات في مكان واحد مع نسخ سريع وتنظيم واضح حسب السوق.',`${pageHero('كل كوبونات نون','الثمانية أكواد الحالية معروضة لكل من السعودية والإمارات.',breadcrumbs(['كل الأكواد']))}<section class="section"><div class="shell"><div class="head"><div><h2>🇸🇦 السعودية</h2><p>8 أكواد حالية</p></div><a href="/saudi-arabia">صفحة السعودية ←</a></div><div class="grid">${sa}</div></div></section><section class="section alt"><div class="shell"><div class="head"><div><h2>🇦🇪 الإمارات</h2><p>8 أكواد حالية</p></div><a href="/uae">صفحة الإمارات ←</a></div><div class="grid">${ae}</div></div></section>`,'/coupons');
}
