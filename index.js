...
function home(){
  ...
  <section class="hero"><div class="shell heroGrid"><div><span class="eyebrow">خصومات نون · السعودية والإمارات</span><h1>كل ما تحتاجه لتجربة <span>كوبونات نون</span> بثقة</h1><p>بدل ما تدور بين صفحات كثيرة، جمعنا لك الأكواد العشرة الحالية، صفحات منفصلة لكل دولة، تصنيفات شراء، وأدلة سريعة تساعدك تتأكد من الكود قبل الدفع.</p><div class="heroActions"><a class="btn primary" href="/coupons">عرض كل الأكواد</a><a class="btn" href="/saudi">🇸🇦 السعودية</a><a class="btn" href="/uae">🇦🇪 الإمارات</a></div><div class="chips"><span class="badge">10 أكواد حالية</span><span class="badge">42 تصنيف شراء</span><span class="badge">8 أدلة عملية</span><span class="badge">مصر: مخفية لحين التفعيل</span></div></div><aside class="heroPanel"><span class="pill">اختيار سريع</span><h2 style="font-size:30px;margin:12px 0 8px">ابدأ بالكود NOV170</h2><p class="small">انسخه وجرّبه في سلتك. لو لم ينطبق، انتقل للكود التالي من القائمة بدون افتراض نسبة خصم غير مؤكدة.</p><div class="codeRow" style="margin-top:18px"><div class="code" style="background:#fff;color:#111827">NOV170</div><button class="copy" data-copy="NOV170">نسخ الكود</button></div><div class="stat"><div class="statBox"><b>10</b><span class="small">أكواد</span></div><div class="statBox"><b>2</b><span class="small">أسواق Live</span></div><div class="statBox"><b>42</b><span class="small">تصنيف</span></div></div></aside></div></section>
...
function couponsPage(){
  ...
  return layout('كل كوبونات نون السعودية والإمارات | 16 بطاقة كوبون','اعرض الأكواد العشرة للسعودية والعشرة للإمارات في مكان واحد مع نسخ سريع وتنظيم واضح حسب السوق.',`${pageHero('كل كوبونات نون','الثمانية أكواد الحالية معروضة لكل من السعودية والإمارات.',breadcrumbs(['كل الأكواد']))}<section class="section"><div class="shell"><div class="head"><div><h2>🇸🇦 السعودية</h2><p>10 أكواد حالية</p></div><a href="/saudi">صفحة السعودية ←</a></div><div class="grid">${sa}</div></div></section><section class="section alt"><div class="shell"><div class="head"><div><h2>🇦🇪 الإمارات</h2><p>10 أكواد حالية</p></div><a href="/uae">صفحة الإمارات ←</a></div><div class="grid">${ae}</div></div></section>`,'/coupons');
}
...
function searchPage(url){
  ...
  return layout(`البحث${q?' عن '+q:''} | ${SITE.name}`,'ابحث في أكواد نون والتصنيفات وأدلة التوفير.',`${pageHero('البحث في الموقع','ابحث بكود مثل NOV170 أو باسم قسم مثل الإلكترونيات.',breadcrumbs(['البحث']))}<section class="section"><div class="shell"><form class="search" data-search><input name="q" value="${esc(q)}" placeholder="ابحث عن كود أو تصنيف أو دليل"><button class="btn primary">بحث</button></form><div class="grid3" style="margin-top:18px">${results.length?results.join(''):`<div class="empty">لا توجد نتائج مطابقة. جرّب NOV170 أو الإلكترونيات أو السعودية.</div>`}</div></div></section>`,'/search',[],'noindex,follow');
}
