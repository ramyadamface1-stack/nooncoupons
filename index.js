...
const MARKETS = {
  SA: { label: 'السعودية', flag: '🇸🇦', currency: 'ر.س', path: '/saudi', noon: 'https://www.noon.com/saudi-ar/' },
...
function nav(){return `<div class="topline"><div class="shell"><span>تحديث الأكواد: ${esc(nowDate())}</span><span>السعودية 🇸🇦 · الإمارات 🇦🇪</span></div></div><header class="top"><div class="shell nav"><a class="brand" href="/"><span class="logo">%</span><span>${SITE.name}</span></a><nav><a href="/">الرئيسية</a><a href="/coupons">كل الأكواد</a><a href="/saudi">السعودية</a><a href="/uae">الإمارات</a><a href="/categories">التصنيفات</a><a href="/blog">الأدلة</a><a href="/shopping-world">عالم التسوق</a></nav><a class="btn soft mobileMenu" href="/coupons">الأكواد</a></div></header>`}
function footer(){return `<footer class="footer"><div class="shell footgrid"><div><div class="brand"><span class="logo">%</span><span>${SITE.name}</span></div><p class="small">منصة مستقلة تساعد المتسوق على تجربة أكواد نون ومقارنة خيارات التوفير في السعودية والإمارات. لا ننسب نسبة خصم أو أهلية لأي كود بدون بيانات موثقة.</p></div><div><b>الدول</b><p><a href="/saudi">نون السعودية</a></p><p><a href="/uae">نون الإمارات</a></p><p><span class="small">مصر — قريبًا</span></p></div><div><b>استكشف</b><p><a href="/coupons">كل الأكواد</a></p><p><a href="/categories">التصنيفات</a></p><p><a href="/blog">الأدلة</a></p></div><div><b>الموقع</b><p><a href="/about">من نحن</a></p><p><a href="/contact">اتصل بنا</a></p><p><a href="/privacy">الخصوصية</a></p></div></div></footer>`}
...
function home(){
  ...
  const categories=CATEGORIES.slice(0,12).map(c=>`<div class="cat"><b>${c[1]}</b><p>${c[2]}</p><p><a href="/saudi/category/${c[0]}">🇸🇦 السعودية</a> · <a href="/uae/category/${c[0]}">🇦🇪 الإمارات</a></p></div>`).join('');
  ...
  <section class="hero"><div class="shell heroGrid"><div><span class="eyebrow">خصومات نون · السعودية والإمارات</span><h1>كل ما تحتاجه لتجربة <span>كوبونات نون</span> بثقة</h1><p>بدل ما تدور بين صفحات كثيرة، جمعنا لك الأكواد الثمانية الحالية، صفحات منفصلة لكل دولة، تصنيفات شراء، وأدلة سريعة تساعدك تتأكد من الكود قبل الدفع.</p><div class="heroActions"><a class="btn primary" href="/coupons">عرض كل الأكواد</a><a class="btn" href="/saudi">🇸🇦 السعودية</a><a class="btn" href="/uae">🇦🇪 الإمارات</a></div><div class="chips"><span class="badge">8 أكواد حالية</span><span class="badge">42 تصنيف شراء</span><span class="badge">8 أدلة عملية</span><span class="badge">مصر: مخفية لحين التفعيل</span></div></div><aside class="heroPanel"><span class="pill">اختيار سريع</span><h2 style="font-size:30px;margin:12px 0 8px">ابدأ بالكود OPS32</h2><p class="small">انسخه وجرّبه في سلتك. لو لم ينطبق، انتقل للكود التالي من القائمة بدون افتراض نسبة خصم غير مؤكدة.</p><div class="codeRow" style="margin-top:18px"><div class="code" style="background:#fff;color:#111827">OPS32</div><button class="copy" data-copy="OPS32">نسخ الكود</button></div><div class="stat"><div class="statBox"><b>8</b><span class="small">أكواد</span></div><div class="statBox"><b>2</b><span class="small">أسواق Live</span></div><div class="statBox"><b>42</b><span class="small">تصنيف</span></div></div></aside></div></section>
  ...
  <section class="section"><div class="shell"><div class="head"><div><h2>اختر بلدك أولًا</h2><p>فصل السوقين يقلل خلط الشروط والعملات ويسهّل تحديث كل دولة بشكل مستقل.</p></div></div><div class="grid"><a class="market" href="/saudi"><div class="flag">🇸🇦</div><h3>نون السعودية</h3><p class="small">صفحة مخصصة للسعودية، الأكواد الثمانية، أسئلة الاستخدام، وأفضل طريقة لفحص السلة قبل الدفع.</p><span class="btn soft">عرض السعودية</span></a><a class="market" href="/uae"><div class="flag">🇦🇪</div><h3>نون الإمارات</h3><p class="small">صفحة منفصلة للإمارات مع نفس الأكواد الحالية ودليل واضح للتحقق من الأهلية.</p><span class="btn soft">عرض الإمارات</span></a></div></div></section>
...
function searchPage(url){
  ...
  const results=[...codeHits.map(c=>`<a class="guide" href="/coupon/${c.toLowerCase()}"><span class="kicker">كود</span><h3>${c}</h3><p>صفحة الكود للسعودية والإمارات.</p></a>`),...catHits.flatMap(c=>[`<a class="guide" href="/saudi/category/${c[0]}"><span class="kicker">تصنيف · السعودية</span><h3>${c[1]}</h3><p>${c[2]}</p></a>`,`<a class="guide" href="/uae/category/${c[0]}"><span class="kicker">تصنيف · الإمارات</span><h3>${c[1]}</h3><p>${c[2]}</p></a>`]),...guideHits.map(g=>`<a class="guide" href="/guide/${g[0]}"><span class="kicker">دليل</span><h3>${g[1]}</h3><p>${g[2]}</p></a>`)];
...
function adminPage(env){
  ...
  return `<!doctype html><html lang="ar" dir="rtl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>Admin | ${SITE.name}</title><style>${CSS}</style></head><body class="admin"><div class="adminShell"><div style="display:flex;justify-content:space-between;gap:14px;align-items:center"><div><span class="pill">Cloudflare Control Plane</span><h1>لوحة إدارة ${SITE.name}</h1><p style="color:#94a3b8">ملخص حالة المحتوى والبنية الحالية.</p></div><a class="btn" href="/">فتح الموقع</a></div><div class="adminGrid"><div class="adminCard"><span class="pill">Coupons</span><b>16</b><small>8 SA + 8 AE</small></div><div class="adminCard"><span class="pill">Categories</span><b>${CATEGORIES.length}</b><small>صفحات شراء</small></div><div class="adminCard"><span class="pill">Guides</span><b>${GUIDES.length}</b><small>أدلة تحريرية</small></div><div class="adminCard"><span class="pill">Quality</span><b>245</b><small>معيار مستهدف</small></div></div><div class="adminCard" style="margin-top:16px"><h2>حالة الأمان</h2><p>${locked?'🔒 اللوحة في وضع آمن للقراءة فقط لأن SESSION_SECRET / BOOTSTRAP_SECRET غير مضبوطين. أضف الأسرار في Cloudflare قبل تفعيل أي عمليات كتابة.':'✅ أسرار الإدارة موجودة في البيئة. يمكن توصيل واجهات الكتابة بعد التحقق من المصادقة.'}</p></div><div class="adminGrid" style="margin-top:16px"><div class="adminCard"><h3>AI Studio</h3><p>Cloudflare Workers AI فقط حسب إعدادات Worker.</p></div><div class="adminCard"><h3>Articles</h3><p>Draft / Scheduled / Published مع R2 للمحتوى عند تفعيل واجهات الكتابة.</p></div><div class="adminCard"><h3>Coupons</h3><p>الدولة، الأهلية، الشروط، الأولوية، التحقق، الحالة.</p></div><div class="adminCard"><h3>Quality 245</h3><p>Generate → Audit → Repair → Re-audit قبل النشر.</p></div></div></div></body></html>`;
}
...
function health(env){return {ok:true,site:SITE.name,version:'premium-live-3.2',codes:CODES.length,couponCards:16,markets:['SA','AE'],planned:['EG'],categories:CATEGORIES.length,guides:GUIDES.length,qualityCriteria:245,d1:Boolean(env?.CONTROL_DB),r2:Boolean(env?.CONTENT),queue:Boolean(env?.PUBLISH_QUEUE),timestamp:new Date().toISOString()}}
...
async function handle(request,env){
  ...
  if(path==='/ksa'||path==='/sa'||path==='/saudi-arabia')return redirect('/saudi');
  ...
  if(path==='/saudi')return htmlResponse(marketPage('SA'));
