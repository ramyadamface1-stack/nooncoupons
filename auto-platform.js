...
async function bulkArticlePage(u,env){
  ...
  const body=await o.text(),canonical=origin+'/articles/'+encodeURI(slug),market=country==='SA'?'السعودية':'الإمارات',lang=country==='SA'?'ar-SA':'ar-AE',marketPath=country==='SA'?'/saudi-arabia':'/uae',published=md.at||now();
  ...
  const graph={'@context':'https://schema.org','@graph':[
    ...
    {'@type':'Article','@id':canonical+'#article',headline:title,description:meta,inLanguage:lang,mainEntityOfPage:{'@id':canonical+'#webpage'},datePublished:published,dateModified:published,author:{'@id':origin+'/#organization'},publisher:{'@id':origin+'/#organization'},image:images,about:[{'@type':'Thing',name:'Noon'},{'@type':'Thing',name:keyword},{'@type':'Place',name:market}]}
  ]};
