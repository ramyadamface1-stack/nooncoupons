...
console.log(JSON.stringify({engine:BULK_ENGINE_INFO,globalIndex:GLOBAL_INDEX_INFO,couponRegistry:COUPON_REGISTRY_INFO,ready,rejected,minScore,maxScore,minWords,maxWords,groupMins,clusters:clusters.size},null,2));
...
console.log(`READY_COUNT=${ready}/40 REJECTED=${rejected} MIN_SCORE=${minScore} MAX_SCORE=${maxScore} WORDS=${minWords}-${maxWords} GLOBAL_INDEX_V=${GLOBAL_INDEX_INFO.version} COUPON_REGISTRY=${COUPON_REGISTRY_INFO.version}`);
